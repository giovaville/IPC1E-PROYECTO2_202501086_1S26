...
public class PanelAlbum extends JPanel {
    ...
    public PanelAlbum(ControlPrincipal control) {
        ...
        lblMensaje = new JLabel("Aquí irá el módulo del álbum.", SwingConstants.CENTER);
        ...
        btnRegresar.addActionListener(e -> {
            java.awt.Window ventana = javax.swing.SwingUtilities.getWindowAncestor(PanelAlbum.this);
