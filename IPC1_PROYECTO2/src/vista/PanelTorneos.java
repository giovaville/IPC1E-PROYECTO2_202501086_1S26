...
public class PanelTorneos extends JPanel {
    ...
    public PanelTorneos(ControlPrincipal control) {
        ...
        lblMensaje = new JLabel("Aquí irá el módulo de torneos.", SwingConstants.CENTER);
        ...
        btnRegresar.addActionListener(e -> {
            java.awt.Window ventana = javax.swing.SwingUtilities.getWindowAncestor(PanelTorneos.this);
