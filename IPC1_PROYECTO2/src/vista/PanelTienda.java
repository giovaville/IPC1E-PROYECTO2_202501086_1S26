...
public class PanelTienda extends JPanel {
    ...
    public PanelTienda(ControlPrincipal control) {
        ...
        lblMensaje = new JLabel("Aquí irá el módulo de tienda.", SwingConstants.CENTER);
        ...
        btnRegresar.addActionListener(e -> {
            java.awt.Window ventana = javax.swing.SwingUtilities.getWindowAncestor(PanelTienda.this);
